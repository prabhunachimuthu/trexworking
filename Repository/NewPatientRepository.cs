...
namespace OneDirect.Repository
{
    public class NewPatientRepository : INewPatient
    {
        ...
        public NewPatientRepository(OneDirectContext context, IEquipmentExerciseInterface EquipmentExerciseRepository)
        {
        ...
        public NewProtocol GetProtocolByproId(string proId)
        {
            ...
            return (from p in context.Protocol
                    ...
                    select new NewProtocol
                    {
                        ...
                        ExcerciseName = getProtocolType(p.EquipmentType, p.ProtocolEnum, p.DeviceConfiguration, llist),
                        Rx = p.Rx,
